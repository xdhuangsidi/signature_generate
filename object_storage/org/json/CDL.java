    ...
    public static String rowToString(JSONArray ja) {
        ...
        for (int i = 0; i < ja.length(); i++) {
            ...
            if (object != null) {
                ...
                if (string.length() <= 0 || (string.indexOf(44) < 0 && string.indexOf(10) < 0 && string.indexOf(13) < 0 && string.indexOf(0) < 0 && string.charAt(0) != TokenParser.DQUOTE)) {
                    sb.append(string);
                } else {
                    ...
                    for (int j = 0; j < length; j++) {
                        ...
                        if (c >= TokenParser.SP && c != TokenParser.DQUOTE) {
                            sb.append(c);
                        }
                    }
                    sb.append(TokenParser.DQUOTE);
