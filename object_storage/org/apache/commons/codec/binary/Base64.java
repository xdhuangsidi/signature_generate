...
public class Base64 extends BaseNCodec {
        ...
        if (!context.eof) {
                ...
                if (context.modulus != 0 || this.lineLength != 0) {
                    ...
                    switch (context.modulus) {
                        ...
                        case 1:
                            ...
                            i = context.pos;
                            context.pos = i + 1;
                            buffer[i] = this.encodeTable[(context.ibitWorkArea << 4) & MASK_6BITS];
            ...
            while (i2 < inAvail) {
                ...
                if (context.modulus == 0) {
                    ...
                    i = context.pos;
                    context.pos = i + 1;
                    buffer[i] = this.encodeTable[(context.ibitWorkArea >> 6) & MASK_6BITS];
                    i = context.pos;
                    context.pos = i + 1;
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked, boolean urlSafe) {
        return encodeBase64(binaryData, isChunked, urlSafe, Priority.OFF_INT);
    }
