...
public class UnixCrypt {
    ...
    private static int byteToUnsigned(byte b) {
        byte value = b;
        return value < (byte) 0 ? value + JSONzip.end : value;
    }
    ...
    private static int[] desSetKey(byte[] key) {
        ...
        d = results[0];
        int c = results[1];
        d = ((((d & 255) << 16) | (65280 & d)) | ((16711680 & d) >>> 16)) | ((-268435456 & c) >>> 4);
        c &= 268435455;
        int j = 0;
        for (int i = 0; i < 16; i++) {
            if (SHIFT2[i]) {
