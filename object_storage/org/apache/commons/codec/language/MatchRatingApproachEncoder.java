...
public class MatchRatingApproachEncoder implements StringEncoder {
    ...
    int getMinRating(int sumLength) {
        ...
        if (sumLength >= 8 && sumLength <= ELEVEN) {
            return 3;
        }
        if (sumLength == TWELVE) {
            return 2;
    ...
    public boolean isEncodeEquals(String name1, String name2) {
        boolean z = true;
        if (name1 == null || EMPTY.equalsIgnoreCase(name1) || SPACE.equalsIgnoreCase(name1) || name2 == null || EMPTY.equalsIgnoreCase(name2) || SPACE.equalsIgnoreCase(name2) || name1.length() == 1 || name2.length() == 1) {
            return false;
        }
