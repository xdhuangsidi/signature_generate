    ...
    private String buildString() {
        ...
        if (this.encodedSchemeSpecificPart != null) {
            ...
            if (this.encodedQuery != null) {
                sb.append(LocationInfo.NA).append(this.encodedQuery);
            } else if (this.queryParams != null) {
                sb.append(LocationInfo.NA).append(encodeUrlForm(this.queryParams));
            } else if (this.query != null) {
                sb.append(LocationInfo.NA).append(encodeUric(this.query));
            }
        }
