...
public class URLEncodedUtils {
    ...
    private static final BitSet PATHSAFE = new BitSet(JSONzip.end);
    private static final BitSet PUNCT = new BitSet(JSONzip.end);
    private static final char QP_SEP_A = '&';
    private static final char QP_SEP_S = ';';
    private static final int RADIX = 16;
    private static final BitSet RESERVED = new BitSet(JSONzip.end);
    private static final BitSet UNRESERVED = new BitSet(JSONzip.end);
    private static final BitSet URIC = new BitSet(JSONzip.end);
    private static final BitSet URLENCODER = new BitSet(JSONzip.end);
    private static final BitSet USERINFO = new BitSet(JSONzip.end);
